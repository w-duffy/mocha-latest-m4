      ...
      agent3
        ...
        .end(function (err, res) {
          if (res.status !== 401 && res.status !== 403) {
            return done(new Error(`Expected status 401 or 403, but got ${res.status}`));
          }
          done()
        });
